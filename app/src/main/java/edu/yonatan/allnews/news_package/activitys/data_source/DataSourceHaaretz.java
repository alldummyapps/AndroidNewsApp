...
public class DataSourceHaaretz extends AsyncTask<Void, Void, List<News>> {
    ...
    public DataSourceHaaretz(ProgressBar progressBar, RecyclerView recyclerView, String address) {
    ...
    protected List<News> doInBackground(Void... voids) {
        ...
        try {
            ...
            for (Element element : itemList) {
                ...
                String execrpt = element.getElementsByTag("description").first().text();
                ...
                News aNews = new News(title, execrpt, img, link);
